...
$sql = "SELECT * FROM articulo where tipo = 'Gato'";
if (isset($_GET['opcion'])) {
   $opcionSeleccionada = $_GET['opcion'];
...
$sql = "SELECT * FROM articulo where tipo = 'Perro'";
if (isset($_GET['opcion'])) {
   $opcionSeleccionada = $_GET['opcion'];
...
$sql = "SELECT * FROM articulo WHERE idcategoria = 1";
if (isset($_GET['opcion'])) {
   $opcionSeleccionada = $_GET['opcion'];
...
$sql = "SELECT * FROM articulo WHERE idcategoria = 2";
if (isset($_GET['opcion'])) {
   $opcionSeleccionada = $_GET['opcion'];
...
$sql = "SELECT * FROM articulo WHERE idcategoria = 3";
if (isset($_GET['opcion'])) {
   $opcionSeleccionada = $_GET['opcion'];
...
$sql = "SELECT * FROM articulo WHERE idcategoria = 7";
if (isset($_GET['opcion'])) {
   $opcionSeleccionada = $_GET['opcion'];
...
$sql = "SELECT * FROM articulo WHERE idcategoria = 8";
if (isset($_GET['opcion'])) {
   $opcionSeleccionada = $_GET['opcion'];
