...
-- Tiempo de generación: 20-06-2023 a las 12:12:50
...
(4, 1, 'JG001', 'Gimnasio Para Gato Tipo Silla', '170000.00', NULL, 1, 5, 'Colores sujetos a disponibilidad, el color llega de manera aleatoria.', 'U', NULL, '../assets/gato/JG001.png', b'1', 'Gato'),
...
(26, 6, 'CC001', 'Cama Para Perro Doble faz SofistiPets Negro - Mediana (20x75x50)', '250000.00', NULL, NULL, 5, 'Espectacular cama para perros! Ideal para un buen descanso y comodidad. Dos colores en una cama, hecha en poliéster y desarmable para lavado.\r\n\r\nLa mediana ideal para perros de hasta 50cm de largo y la grande ideal para perros de hasta 80cm de largo(del cu', NULL, NULL, '../assets/perro/CC001.png', b'1', 'Perro'),
...
--
-- Volcado de datos para la tabla `historiasmascotas`
--

INSERT INTO `historiasmascotas` (`ID`, `ID_Usuario`, `NombreMascota`, `Historia`, `foto`) VALUES
(1, 1, 'Romeo', 'Romeo es un gatico, recogido de la calle siendo aun bebe, enfermo, solito y desamparado. El\r\n                            ha llegado a alegrar nuestras vidas, es un nene caprichoso, amoroso.\r\n                            Nos encanta su compañía.', 'Romeo.jpeg');
