        ...
        <main>
            <section class="description">
                <div class="navegacion">
                    <h2><a href="dogs.php">Perros / </a><a href="description.php">Producto</a></h2>
                </div>
                <div class="container__description">

                    <div class="description__text">
                        <h1 class="description__title">descripcion</h1>
                        <p class="description__copy">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque
                            ultricies
                            leo eget metus ultricies, ut lacinia lectus congue. Fusce varius massa vel eleifend
                            interdum. In hac
                            habitasse platea dictumst. Curabitur finibus tortor a urna maximus dictum. Proin lobortis
                            augue vitae
                            libero tincidunt, ut efficitur est gravida. Maecenas tristique turpis at tortor commodo,
                            vitae
                            lacinia sapien varius. Donec sollicitudin erat vitae ante aliquam dictum. Sed euismod nunc
                            eu nunc
                            dignissim iaculis. Maecenas consectetur orci mauris, vitae lacinia arcu blandit sit amet.
                            Cras sed
                            sagittis metus, id convallis leo. Vestibulum ante ipsum primis in faucibus orci luctus et
                            ultrices
                            posuere cubilia curae; Donec varius tellus sit amet aliquam dignissim. Morbi venenatis velit
                            ut
                            mauris vulputate bibendum. Etiam mollis sem vel sagittis efficitur. Etiam sit amet semper
                            erat.</p>
                    </div>

                    <div class="description__img">
                        <img src=".././assets/perro/bozal.png" alt="Producto">
                    </div>
