...
<head>
    ...
    <title>Arena y areneras</title>
</head>

<body onload="ordenarArticulosSand()">
    <header>
    ...
    <main>
        <section class="products">
            <h1 class="products__title">Arena y areneras</h1>
            <div class="products__select" onchange="ordenarArticulosSand()">
                <select id="select">
