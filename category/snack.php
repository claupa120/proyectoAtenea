...
<head>
    ...
    <title>Snack y premios</title>
</head>


<body onload="ordenarArticulos(7)">
    <header>
    ...
    <main>
        <section class="products">
            <h1 class="products__title">Snack y premios</h1>
            <div class="products__select" onchange="ordenarArticulos(7)">
                <select id="select">
